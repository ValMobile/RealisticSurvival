...
public class FollowOwnerGoal_v1_16_R1 extends PathfinderGoal {
    ...
    public FollowOwnerGoal_v1_16_R1(RSVPet pet, double d0, float f, float f1, boolean flag) {
        this.pet = pet;
    ...
    public void e() {
        ...
        mob.getControllerLook().a(owner, 10.0F, (float) mob.eo());
