...
public enum CustomEntities_v1_21_R5 {
    ...
    ENDERMAN_ALLY("enderman_ally", -1, EntityType.ENDERMAN, EnderMan.class, EndermanAlly_v1_21_R5.class),
    FIRE_DRAGON("fire_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, FireDragon_v1_21_R5.class),
    ICE_DRAGON("ice_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, IceDragon_v1_21_R5.class),
    LIGHTNING_DRAGON("lightning_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, LightningDragon_v1_21_R5.class),
    SEA_SERPENT("sea_serpent", -1, EntityType.ELDER_GUARDIAN, ElderGuardian.class, SeaSerpent_v1_21_R5.class),
    SIREN("siren", -1, EntityType.GUARDIAN, Guardian.class, Siren_v1_21_R5.class);
    ...
    CustomEntities_v1_21_R5(String name, int id, EntityType<?> entityType, Class<? extends Mob> nmsClass,
    ...
    private static void unfreezeRegistry() {
        ...
        try {
            Field intrusiveHolderCache = registryClass.getDeclaredField(ObfuscatedFields_v1_21_R5.INTRUSIVE_HOLDER_CACHE_SYMBOL);
            intrusiveHolderCache.setAccessible(true);
            intrusiveHolderCache.set(BuiltInRegistries.ENTITY_TYPE, new IdentityHashMap<EntityType<?>, Holder.Reference<EntityType<?>>>());
            Field frozen = registryClass.getDeclaredField(ObfuscatedFields_v1_21_R5.FROZEN_SYMBOL);
            ...
            for (Class<?> nestedClass : MappedRegistry.class.getDeclaredClasses()) {
                if (nestedClass.getName().equals(ObfuscatedFields_v1_21_R5.TAGSET_SYMBOL_OBFUSCATED) || nestedClass.getName().equals(ObfuscatedFields_v1_21_R5.TAGSET_SYMBOL_UNOBFUSCATED)) {
            ...
            Field allTags = registryClass.getDeclaredField(ObfuscatedFields_v1_21_R5.ALL_TAGS_SYMBOL);
