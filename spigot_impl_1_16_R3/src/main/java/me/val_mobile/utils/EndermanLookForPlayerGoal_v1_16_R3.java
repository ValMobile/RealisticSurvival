...
public class EndermanLookForPlayerGoal_v1_16_R3 extends PathfinderGoalNearestAttackableTarget<EntityPlayer> {
    ...
    public EndermanLookForPlayerGoal_v1_16_R3(EntityEnderman enderman, @Nullable Predicate<EntityLiving> predicate) {
        super(enderman, EntityPlayer.class, 10, false, false, predicate);
        this.enderman = enderman;
        this.startAggroTargetConditions = PathfinderTargetCondition.a.a(k()).a((entityliving) -> v1_16_R3.isLookingAtMe(enderman, (EntityPlayer) entityliving));
    }
    ...
    public boolean b() {
        if (pendingTarget != null) {
            if (v1_16_R3.isLookingAtMe(enderman, pendingTarget)) {
    ...
    public void e() {
        ...
        if (pendingTarget != null) {
            ...
            if (c != null && !enderman.isPassenger()) {
                if (v1_16_R3.isLookingAtMe(enderman, (EntityPlayer) c)) {
                    if (c.h(enderman) < 16.0) {
                        v1_16_R3.teleport(enderman);
                    }
                    teleportTime = 0;
                }
                else if (c.h(enderman) > 256.0 && teleportTime++ >= 30 && v1_16_R3.teleportTowards(enderman, c)) {
                    teleportTime = 0;
                }
            }
            super.e();
