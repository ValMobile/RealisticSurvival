...
public class Siren_v1_16_R3 extends EntityGuardian implements Siren {

    private final FileConfiguration config;

    public Siren_v1_16_R3(EntityTypes<? extends EntityGuardian> entitytypes, World world) {
    ...
    public Siren_v1_16_R3(Location loc) {
