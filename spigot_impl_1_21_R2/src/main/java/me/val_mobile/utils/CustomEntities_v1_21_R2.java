...
public enum CustomEntities_v1_21_R2 {

    ENDERMAN_ALLY("enderman_ally", -1, EntityType.ENDERMAN, EnderMan.class, EndermanAlly_v1_21_R2.class),
    FIRE_DRAGON("fire_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, FireDragon_v1_21_R2.class),
    ICE_DRAGON("ice_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, IceDragon_v1_21_R2.class),
    LIGHTNING_DRAGON("lightning_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, LightningDragon_v1_21_R2.class),
    SEA_SERPENT("sea_serpent", -1, EntityType.ELDER_GUARDIAN, ElderGuardian.class, SeaSerpent_v1_21_R2.class),
    SIREN("siren", -1, EntityType.GUARDIAN, Guardian.class, Siren_v1_21_R2.class);
    ...
    CustomEntities_v1_21_R2(String name, int id, EntityType<?> entityType, Class<? extends Mob> nmsClass,
    ...
    public static void registerEntities() {
        ...
        unfreezeRegistry();
        registerEntity("fire_dragon", FireDragon_v1_21_R2::new, types);
        registerEntity("ice_dragon", IceDragon_v1_21_R2::new, types);
        registerEntity("lightning_dragon", LightningDragon_v1_21_R2::new, types);
        registerEntity("enderman_ally", EndermanAlly_v1_21_R2::new, types);
        registerEntity("sea_serpent", SeaSerpent_v1_21_R2::new, types);
        registerEntity("siren", Siren_v1_21_R2::new, types);
    ...
    private static void unfreezeRegistry() {
        ...
        try {
            Field intrusiveHolderCache = registryClass.getDeclaredField(ObfuscatedFields_v1_21_R2.INTRUSIVE_HOLDER_CACHE_SYMBOL);
            intrusiveHolderCache.setAccessible(true);
            intrusiveHolderCache.set(BuiltInRegistries.ENTITY_TYPE, new IdentityHashMap<EntityType<?>, Holder.Reference<EntityType<?>>>());
            Field frozen = registryClass.getDeclaredField(ObfuscatedFields_v1_21_R2.FROZEN_SYMBOL);
