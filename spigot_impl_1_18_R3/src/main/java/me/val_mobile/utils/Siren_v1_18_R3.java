...
public class Siren_v1_18_R3 extends Guardian implements Siren {

    public Siren_v1_18_R3(EntityType<? extends Guardian> entitytype, Level world) {
        super(entitytype, world);

        setup();
    }

    public Siren_v1_18_R3(Location loc) {
