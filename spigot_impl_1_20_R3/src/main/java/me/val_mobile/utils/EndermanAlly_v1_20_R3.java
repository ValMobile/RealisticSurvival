...
public class EndermanAlly_v1_20_R3 extends EnderMan implements EndermanAlly {

    private final net.minecraft.world.entity.player.Player owner;

    public EndermanAlly_v1_20_R3(EntityType<? extends EnderMan> entityTypes, Level world) {
        super(entityTypes, world);
        this.owner = null;
        addNbtData();
    }

    public EndermanAlly_v1_20_R3(Player owner, Location loc) {
    ...
    protected void registerGoals() {
        ...
        goalSelector.addGoal(1, new EndermanFreezeWhenLookedAtGoal_v1_20_R3(this));
        goalSelector.addGoal(3, new FollowOwnerGoal_v1_20_R3(this, 1.0, 10.0F, 2.0F, false));
        ...
        goalSelector.addGoal(10, new EndermanLeaveBlockGoal_v1_20_R3(this));
        goalSelector.addGoal(11, new EndermanTakeBlockGoal_v1_20_R3(this));
        targetSelector.addGoal(1, new OwnerHurtByTargetGoal_v1_20_R3(this));
        targetSelector.addGoal(2, new OwnerHurtTargetGoal_v1_20_R3(this));
        targetSelector.addGoal(3, new EndermanLookForPlayerGoal_v1_20_R3(this, this::isAngryAt));
