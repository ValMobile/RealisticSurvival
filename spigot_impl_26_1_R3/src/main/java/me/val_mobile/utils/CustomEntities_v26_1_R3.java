...
public enum CustomEntities_v26_1_R3 {

    ENDERMAN_ALLY("enderman_ally", -1, EntityType.ENDERMAN, EnderMan.class, EndermanAlly_v26_1_R3.class),
    FIRE_DRAGON("fire_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, FireDragon_v26_1_R3.class),
    ICE_DRAGON("ice_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, IceDragon_v26_1_R3.class),
    LIGHTNING_DRAGON("lightning_dragon", -1, EntityType.ENDER_DRAGON, EnderDragon.class, LightningDragon_v26_1_R3.class),
    SEA_SERPENT("sea_serpent", -1, EntityType.ELDER_GUARDIAN, ElderGuardian.class, SeaSerpent_v26_1_R3.class),
    SIREN("siren", -1, EntityType.GUARDIAN, Guardian.class, Siren_v26_1_R3.class);
    ...
    CustomEntities_v26_1_R3(String name, int id, EntityType<?> entityType, Class<? extends Mob> nmsClass,
    ...
    public static void registerEntities() {
        ...
        unfreezeRegistry();
        registerEntity("fire_dragon", FireDragon_v26_1_R3::new, types);
        registerEntity("ice_dragon", IceDragon_v26_1_R3::new, types);
        registerEntity("lightning_dragon", LightningDragon_v26_1_R3::new, types);
        registerEntity("enderman_ally", EndermanAlly_v26_1_R3::new, types);
        registerEntity("sea_serpent", SeaSerpent_v26_1_R3::new, types);
        registerEntity("siren", Siren_v26_1_R3::new, types);
    ...
    private static void unfreezeRegistry() {
        ...
        try {
            Field intrusiveHolderCache = registryClass.getDeclaredField(ObfuscatedFields_v26_1_R3.INTRUSIVE_HOLDER_CACHE_SYMBOL);
            intrusiveHolderCache.setAccessible(true);
            intrusiveHolderCache.set(BuiltInRegistries.ENTITY_TYPE, new IdentityHashMap<EntityType<?>, Holder.Reference<EntityType<?>>>());
            Field frozen = registryClass.getDeclaredField(ObfuscatedFields_v26_1_R3.FROZEN_SYMBOL);
            ...
            for (Class<?> nestedClass : MappedRegistry.class.getDeclaredClasses()) {
                if (nestedClass.getName().equals(ObfuscatedFields_v26_1_R3.TAGSET_SYMBOL_OBFUSCATED) || nestedClass.getName().equals(ObfuscatedFields_v26_1_R3.TAGSET_SYMBOL_UNOBFUSCATED)) {
            ...
            Field allTags = registryClass.getDeclaredField(ObfuscatedFields_v26_1_R3.ALL_TAGS_SYMBOL);
