...
public class Siren_v26_1_R3 extends Guardian implements Siren {

    public Siren_v26_1_R3(EntityType<? extends Guardian> entitytype, Level world) {
        super(entitytype, world);

        setup();
    }

    public Siren_v26_1_R3(Location loc) {
