...
public class v26_1_R3 extends InternalsProvider {
    ...
    public void registerEntities() {
        CustomEntities_v26_1_R3.registerEntities();
    }
    ...
    public static boolean isLookingAtMe(EnderMan enderman, net.minecraft.world.entity.player.Player entityhuman) {
        ItemStack itemstack = entityhuman.getItemBySlot(net.minecraft.world.entity.EquipmentSlot.HEAD);
