...
public class EndermanFreezeWhenLookedAtGoal_v1_16_R5 extends PathfinderGoal {
    private final EntityEnderman enderman;
    @Nullable
    private EntityLiving target;

    public EndermanFreezeWhenLookedAtGoal_v1_16_R5(EntityEnderman enderman) {
    ...
    public boolean a() {
        ...
        if (!(target instanceof EntityPlayer)) {
            ...
            return !(d0 > 256.0) && v1_16_R5.isLookingAtMe(enderman, (EntityPlayer) target);
        }
    }
