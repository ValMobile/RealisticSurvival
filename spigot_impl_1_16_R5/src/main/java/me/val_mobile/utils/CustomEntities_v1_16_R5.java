...
TEST("test", EntityType.GUARDIAN.getTypeId(), EntityTypes.GUARDIAN, Guardian.class, EntityGuardian.class);
    ...
    CustomEntities_v1_16_R5(String name, int id, EntityTypes entityType, Class<? extends Mob> nmsClass,
