...
public class EndermanAlly_v1_19_R2 extends EnderMan implements EndermanAlly {
    ...
    protected void registerGoals() {
        ...
        goalSelector.addGoal(1, new EndermanFreezeWhenLookedAtGoal_v1_19_R2(this));
        goalSelector.addGoal(3, new FollowOwnerGoal_v1_19_R2(this, 1.0, 10.0F, 2.0F, false));
        ...
        goalSelector.addGoal(10, new EndermanLeaveBlockGoal_v1_19_R2(this));
        goalSelector.addGoal(11, new EndermanTakeBlockGoal_v1_19_R2(this));
        targetSelector.addGoal(1, new OwnerHurtByTargetGoal_v1_19_R2(this));
        targetSelector.addGoal(2, new OwnerHurtTargetGoal_v1_19_R2(this));
        targetSelector.addGoal(3, new EndermanLookForPlayerGoal_v1_19_R2(this, this::isAngryAt));
