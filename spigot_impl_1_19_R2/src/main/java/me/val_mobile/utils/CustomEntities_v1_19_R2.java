...
TEST("test", org.bukkit.entity.EntityType.GUARDIAN.getTypeId(), EntityType.GUARDIAN, net.minecraft.world.entity.monster.Guardian.class, org.bukkit.entity.Guardian.class);
...
//        registerEntity("siren", Siren::new, types);
    ...
    private static void unfreezeRegistry() {
        ...
        try {
            Field intrusiveHolderCache = registryClass.getDeclaredField(ObfuscatedFields_v1_19_R2.INTRUSIVE_HOLDER_CACHE);
            intrusiveHolderCache.setAccessible(true);
            intrusiveHolderCache.set(Registry.ENTITY_TYPE, new IdentityHashMap<EntityType<?>, Holder.Reference<EntityType<?>>>());
            Field frozen = registryClass.getDeclaredField(ObfuscatedFields_v1_19_R2.FROZEN);
