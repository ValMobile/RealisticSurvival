...
//        registerEntity("siren", Siren::new, types);
    ...
    private static void unfreezeRegistry() {
        ...
        try {
            Field intrusiveHolderCache = registryClass.getDeclaredField(ObfuscatedFields_v1_19_R3.INTRUSIVE_HOLDER_CACHE);
            intrusiveHolderCache.setAccessible(true);
            intrusiveHolderCache.set(Registry.ENTITY_TYPE, new IdentityHashMap<EntityType<?>, Holder.Reference<EntityType<?>>>());
            Field frozen = registryClass.getDeclaredField(ObfuscatedFields_v1_19_R3.FROZEN);
