...
public class Siren_v1_19_R3 extends Guardian implements Siren {

    private final FileConfiguration config;

    public Siren_v1_19_R3(EntityType<? extends Guardian> entitytype, Level world) {
        super(entitytype, world);

        this.config = RSVModule.getModule(IceFireModule.NAME).getUserConfig().getConfig();
    }

    public Siren_v1_19_R3(Location loc) {
