...
public enum TagList {
    ...
    ENTITY_TYPES_ARROWS(Tag.ENTITY_TYPES_ARROWS),
    ENTITY_TYPES_AXOLOTL_ALWAYS_HOSTILES(Tag.ENTITY_TYPES_AXOLOTL_ALWAYS_HOSTILES),
    ENTITY_TYPES_AXOLOTL_HUNT_TARGETS(Tag.ENTITY_TYPES_AXOLOTL_HUNT_TARGETS),
    ENTITY_TYPES_BEEHIVE_INHABITORS(Tag.ENTITY_TYPES_BEEHIVE_INHABITORS),
    ENTITY_TYPES_FREEZE_HURTS_EXTRA_TYPES(Tag.ENTITY_TYPES_FREEZE_HURTS_EXTRA_TYPES),
    ENTITY_TYPES_FREEZE_IMMUNE_ENTITY_TYPES(Tag.ENTITY_TYPES_FREEZE_IMMUNE_ENTITY_TYPES),
    ENTITY_TYPES_FROG_FOOD(Tag.ENTITY_TYPES_FROG_FOOD),
    ENTITY_TYPES_IMPACT_PROJECTILES(Tag.ENTITY_TYPES_IMPACT_PROJECTILES),
    ENTITY_TYPES_POWDER_SNOW_WALKABLE_MOBS(Tag.ENTITY_TYPES_POWDER_SNOW_WALKABLE_MOBS),
    ENTITY_TYPES_RAIDERS(Tag.ENTITY_TYPES_RAIDERS),
    ENTITY_TYPES_SKELETONS(Tag.ENTITY_TYPES_SKELETONS),
    ...
    FLOWERS(Tag.FLOWERS),
    FLUIDS_LAVA(Tag.FLUIDS_LAVA),
    FLUIDS_WATER(Tag.FLUIDS_WATER),
    ...
    OVERWORLD_NATURAL_LOGS(Tag.OVERWORLD_NATURAL_LOGS),
    PARROTS_SPAWNABLE_ON(Tag.PARROTS_SPAWNABLE_ON),
    PIGLIN_FOOD(Tag.PIGLIN_FOOD),
    PIGLIN_REPELLENTS(Tag.PIGLIN_REPELLENTS),
    PLANKS(Tag.PLANKS),
    POLAR_BEARS_SPAWANABLE_ON_ALTERNATE(Tag.POLAR_BEARS_SPAWNABLE_ON_ALTERNATE),
    PORTALS(Tag.PORTALS),
    ...
    private final org.bukkit.Tag tag;

    TagList(org.bukkit.Tag tag) {
        this.tag = tag;
    }
