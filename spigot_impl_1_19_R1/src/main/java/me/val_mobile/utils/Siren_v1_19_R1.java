...
public class Siren_v1_19_R1 extends Guardian implements Siren {

    private final FileConfiguration config;

    public Siren_v1_19_R1(EntityType<? extends Guardian> entitytype, Level world) {
        super(entitytype, world);

        this.config = RSVModule.getModule(IceFireModule.NAME).getUserConfig().getConfig();
    }

    public Siren_v1_19_R1(Location loc) {
    ...
    public EntityType<? extends net.minecraft.world.entity.Entity> getType() {
        return CustomEntities_v1_19_R1.SIREN.getCustomEntityType();
    }
}
