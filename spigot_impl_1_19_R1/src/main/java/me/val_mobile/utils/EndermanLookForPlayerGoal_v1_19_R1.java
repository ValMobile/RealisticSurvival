...
public class EndermanLookForPlayerGoal_v1_19_R1 extends NearestAttackableTargetGoal<Player> {
    ...
    public EndermanLookForPlayerGoal_v1_19_R1(EnderMan enderman, @Nullable Predicate<LivingEntity> predicate) {
