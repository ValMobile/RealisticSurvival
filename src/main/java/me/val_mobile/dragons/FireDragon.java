...
public class FireDragon extends Dragon {
    ...
    public FireDragon(EntityTypes<? extends EntityEnderDragon> entitytypes, Location loc, RealisticSurvivalPlugin instance) {
        super(entitytypes, loc, me.val_mobile.enums.Dragon.Breed.FIRE, instance);
    ...
    public FireDragon(EntityTypes<? extends EntityEnderDragon> entitytypes, Location loc, int stage, RealisticSurvivalPlugin instance) {
        super(entitytypes, loc, me.val_mobile.enums.Dragon.Breed.FIRE, stage, instance);
