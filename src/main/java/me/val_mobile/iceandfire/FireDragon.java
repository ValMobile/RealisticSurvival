...
public class FireDragon extends Dragon {
    ...
    public FireDragon(EntityTypes<? extends EntityEnderDragon> entitytypes, Location loc, RealisticSurvivalPlugin plugin) {
        super(entitytypes, loc, DragonEnums.Breed.FIRE, plugin);
    ...
    public FireDragon(EntityTypes<? extends EntityEnderDragon> entitytypes, Location loc, int stage, RealisticSurvivalPlugin plugin) {
        super(entitytypes, loc, DragonEnums.Breed.FIRE, stage, plugin);
