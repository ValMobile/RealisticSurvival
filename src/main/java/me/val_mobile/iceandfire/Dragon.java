...
import me.val_mobile.iceandfire.DragonEnums.Variant;
...
public abstract class Dragon extends EntityEnderDragon {
    ...
    private DragonEnums.Breed breed;
    private int stage;
    private int age;
    private DragonEnums.Gender gender;
    private Variant variant;
    private final Collection<ItemStack> loot = new ArrayList<>();
    private final UUID uuid;

    public Dragon(EntityTypes<? extends EntityEnderDragon> entitytypes, Location loc, DragonEnums.Breed breed, RealisticSurvivalPlugin plugin) {
        ...
        if ((int) Math.round(r.nextDouble()) == 1)
            gender = DragonEnums.Gender.MALE;
        else
            gender = DragonEnums.Gender.FEMALE;
    ...
    public Dragon(EntityTypes<? extends EntityEnderDragon> entitytypes, Location loc, DragonEnums.Breed breed, int stage, RealisticSurvivalPlugin plugin) {
        super(entitytypes, ((CraftWorld) loc.getWorld()).getHandle());
        this.setPosition(loc.getX(), loc.getY(), loc.getZ());
...
//        this.setGoalTarget(((CraftArmorStand) armorStand).getHandle());
    ...
    public DragonEnums.Breed getBreed() {
        return breed;
    }
    ...
    public void getGender(DragonEnums.Gender gender) {
        this.gender = gender;
    }
    ...
    public void setBreed(DragonEnums.Breed breed) {
        this.breed = breed;
    }
