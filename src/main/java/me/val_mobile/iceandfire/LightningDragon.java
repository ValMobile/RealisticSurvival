...
public class LightningDragon extends Dragon {
    ...
    public LightningDragon(EntityTypes<? extends EntityEnderDragon> entitytypes, Location loc, RealisticSurvivalPlugin plugin) {
        super(entitytypes, loc, DragonEnums.Breed.LIGHTNING, plugin);
    ...
    public LightningDragon(EntityTypes<? extends EntityEnderDragon> entitytypes, Location loc, int stage, RealisticSurvivalPlugin plugin) {
        super(entitytypes, loc, DragonEnums.Breed.LIGHTNING, stage, plugin);
    ...
    public void generateLoot() {
        ...
        SplittableRandom r = new SplittableRandom(); // create a random variable for calculations
