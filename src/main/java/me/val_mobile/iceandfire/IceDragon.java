...
public class IceDragon extends Dragon {
    ...
    public IceDragon(EntityTypes<? extends EntityEnderDragon> entitytypes, Location loc, RealisticSurvivalPlugin plugin) {
        super(entitytypes, loc, DragonEnums.Breed.ICE, plugin);
    ...
    public IceDragon(EntityTypes<? extends EntityEnderDragon> entitytypes, Location loc, int stage, RealisticSurvivalPlugin plugin) {
        super(entitytypes, loc, DragonEnums.Breed.ICE, stage, plugin);
