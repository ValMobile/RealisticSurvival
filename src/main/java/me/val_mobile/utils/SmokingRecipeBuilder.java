...
public class SmokingRecipeBuilder extends SmokingRecipe {

    public SmokingRecipeBuilder(FileConfiguration config, int index, RealisticSurvivalPlugin instance) {
