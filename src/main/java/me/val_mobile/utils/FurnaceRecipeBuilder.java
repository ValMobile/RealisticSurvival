...
public class FurnaceRecipeBuilder extends FurnaceRecipe {

    public FurnaceRecipeBuilder(FileConfiguration config, int index, RealisticSurvivalPlugin instance) {
