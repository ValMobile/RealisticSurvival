...
public class StonecuttingRecipeBuilder extends StonecuttingRecipe {

    public StonecuttingRecipeBuilder(FileConfiguration config, int index, RealisticSurvivalPlugin instance) {
