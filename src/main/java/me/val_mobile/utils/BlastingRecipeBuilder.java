...
public class BlastingRecipeBuilder extends BlastingRecipe {

    public BlastingRecipeBuilder(FileConfiguration config, int index, RealisticSurvivalPlugin instance) {
