...
import me.val_mobile.iceandfire.DragonGearRunnables;
...
public class SfAbilities {
    ...
    public SfAbilities(RealisticSurvivalPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void FireDragonboneAbility(LivingEntity entity) {
        int fireTicks = RSVFiles.getIfUserConfig().getInt("Abilities.FlamedDragonbone.FireTicks"); // get the fire ticks
    ...
    public void FireDragonsteelAbility(LivingEntity entity) {
        int fireTicks = RSVFiles.getIfUserConfig().getInt("Abilities.FireDragonsteel.FireTicks"); // get the fire ticks
