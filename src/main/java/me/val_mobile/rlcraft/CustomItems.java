...
public class CustomItems {
    ...
    private static ItemStack dragonBoneRapier = new Item(CustomConfig.getItemsConfig(), 224, CustomConfig.getSpartanWeaponryConfig(), Item.RAPIER).getNmsItem();
    private static ItemStack dragonBoneKatana = new Item(CustomConfig.getItemsConfig(), 225, CustomConfig.getSpartanWeaponryConfig(), Item.KATANA).getNmsItem();
    private static ItemStack dragonBoneGreatsword = new Item(CustomConfig.getItemsConfig(), 226, CustomConfig.getSpartanWeaponryConfig(), Item.GREATSWORD).getNmsItem();
    private static ItemStack dragonBoneLongsword = new Item(CustomConfig.getItemsConfig(), 227, CustomConfig.getSpartanWeaponryConfig(), Item.LONGSWORD).getNmsItem();
    private static ItemStack dragonBoneSpear = new Item(CustomConfig.getItemsConfig(), 228, CustomConfig.getSpartanWeaponryConfig(), Item.SPEAR).getNmsItem();
    private static ItemStack dragonBoneSaber = new Item(CustomConfig.getItemsConfig(), 229, CustomConfig.getSpartanWeaponryConfig(), Item.SABER).getNmsItem();
    private static ItemStack dragonBoneBoomerang = new Item(CustomConfig.getItemsConfig(), 230, CustomConfig.getSpartanWeaponryConfig(), Item.BOOMERANG).getNmsItem();
    private static ItemStack dragonBoneDagger = new Item(CustomConfig.getItemsConfig(), 231, CustomConfig.getSpartanWeaponryConfig(), Item.DAGGER).getNmsItem();
    private static ItemStack dragonBoneGlaive = new Item(CustomConfig.getItemsConfig(), 232, CustomConfig.getSpartanWeaponryConfig(), Item.GLAIVE).getNmsItem();
    private static ItemStack dragonBoneHalberd = new Item(CustomConfig.getItemsConfig(), 233, CustomConfig.getSpartanWeaponryConfig(), Item.HALBERD).getNmsItem();
    private static ItemStack dragonBoneHammer = new Item(CustomConfig.getItemsConfig(), 234, CustomConfig.getSpartanWeaponryConfig(), Item.HAMMER).getNmsItem();
    private static ItemStack dragonBoneJavelin = new Item(CustomConfig.getItemsConfig(), 235, CustomConfig.getSpartanWeaponryConfig(), Item.JAVELIN).getNmsItem();
    private static ItemStack dragonBoneLance = new Item(CustomConfig.getItemsConfig(), 236, CustomConfig.getSpartanWeaponryConfig(), Item.LANCE).getNmsItem();
    private static ItemStack dragonBoneMace = new Item(CustomConfig.getItemsConfig(), 237, CustomConfig.getSpartanWeaponryConfig(), Item.MACE).getNmsItem();
    private static ItemStack dragonBonePike = new Item(CustomConfig.getItemsConfig(), 238, CustomConfig.getSpartanWeaponryConfig(), Item.PIKE).getNmsItem();
    private static ItemStack dragonBoneQuarterstaff = new Item(CustomConfig.getItemsConfig(), 239, CustomConfig.getSpartanWeaponryConfig(), Item.QUARTERSTAFF).getNmsItem();
    private static ItemStack dragonBoneThrowingAxe = new Item(CustomConfig.getItemsConfig(), 240, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_AXE).getNmsItem();
    private static ItemStack dragonBoneThrowingKnife = new Item(CustomConfig.getItemsConfig(), 241, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_KNIFE).getNmsItem();
    private static ItemStack dragonBoneWarhammer = new Item(CustomConfig.getItemsConfig(), 242, CustomConfig.getSpartanWeaponryConfig(), Item.WARHAMMER).getNmsItem();
    private static ItemStack dragonBoneBattleaxe = new Item(CustomConfig.getItemsConfig(), 243, CustomConfig.getSpartanWeaponryConfig(), Item.BATTLEAXE).getNmsItem();
    ...
    private static ItemStack flamedDragonBoneRapier = new Item(CustomConfig.getItemsConfig(), 246, CustomConfig.getSpartanWeaponryConfig(), Item.RAPIER).getNmsItem();
    private static ItemStack flamedDragonBoneKatana = new Item(CustomConfig.getItemsConfig(), 247, CustomConfig.getSpartanWeaponryConfig(), Item.KATANA).getNmsItem();
    private static ItemStack flamedDragonBoneGreatsword = new Item(CustomConfig.getItemsConfig(), 248, CustomConfig.getSpartanWeaponryConfig(), Item.GREATSWORD).getNmsItem();
    private static ItemStack flamedDragonBoneLongsword = new Item(CustomConfig.getItemsConfig(), 249, CustomConfig.getSpartanWeaponryConfig(), Item.LONGSWORD).getNmsItem();
    private static ItemStack flamedDragonBoneSpear = new Item(CustomConfig.getItemsConfig(), 250, CustomConfig.getSpartanWeaponryConfig(), Item.SPEAR).getNmsItem();
    private static ItemStack flamedDragonBoneSaber = new Item(CustomConfig.getItemsConfig(), 251, CustomConfig.getSpartanWeaponryConfig(), Item.SABER).getNmsItem();
    private static ItemStack flamedDragonBoneBoomerang = new Item(CustomConfig.getItemsConfig(), 252, CustomConfig.getSpartanWeaponryConfig(), Item.BOOMERANG).getNmsItem();
    private static ItemStack flamedDragonBoneDagger = new Item(CustomConfig.getItemsConfig(), 253, CustomConfig.getSpartanWeaponryConfig(), Item.DAGGER).getNmsItem();
    private static ItemStack flamedDragonBoneGlaive = new Item(CustomConfig.getItemsConfig(), 254, CustomConfig.getSpartanWeaponryConfig(), Item.GLAIVE).getNmsItem();
    private static ItemStack flamedDragonBoneHalberd = new Item(CustomConfig.getItemsConfig(), 255, CustomConfig.getSpartanWeaponryConfig(), Item.HALBERD).getNmsItem();
    private static ItemStack flamedDragonBoneHammer = new Item(CustomConfig.getItemsConfig(), 256, CustomConfig.getSpartanWeaponryConfig(), Item.HAMMER).getNmsItem();
    private static ItemStack flamedDragonBoneJavelin = new Item(CustomConfig.getItemsConfig(), 257, CustomConfig.getSpartanWeaponryConfig(), Item.JAVELIN).getNmsItem();
    private static ItemStack flamedDragonBoneLance = new Item(CustomConfig.getItemsConfig(), 258, CustomConfig.getSpartanWeaponryConfig(), Item.LANCE).getNmsItem();
    private static ItemStack flamedDragonBoneMace = new Item(CustomConfig.getItemsConfig(), 259, CustomConfig.getSpartanWeaponryConfig(), Item.MACE).getNmsItem();
    private static ItemStack flamedDragonBonePike = new Item(CustomConfig.getItemsConfig(), 260, CustomConfig.getSpartanWeaponryConfig(), Item.PIKE).getNmsItem();
    private static ItemStack flamedDragonBoneQuarterstaff = new Item(CustomConfig.getItemsConfig(), 261, CustomConfig.getSpartanWeaponryConfig(), Item.QUARTERSTAFF).getNmsItem();
    private static ItemStack flamedDragonBoneThrowingAxe = new Item(CustomConfig.getItemsConfig(), 262, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_AXE).getNmsItem();
    private static ItemStack flamedDragonBoneThrowingKnife = new Item(CustomConfig.getItemsConfig(), 263, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_KNIFE).getNmsItem();
    private static ItemStack flamedDragonBoneWarhammer = new Item(CustomConfig.getItemsConfig(), 264, CustomConfig.getSpartanWeaponryConfig(), Item.WARHAMMER).getNmsItem();
    private static ItemStack flamedDragonBoneBattleaxe = new Item(CustomConfig.getItemsConfig(), 265, CustomConfig.getSpartanWeaponryConfig(), Item.BATTLEAXE).getNmsItem();
    ...
    private static ItemStack icedDragonBoneRapier = new Item(CustomConfig.getItemsConfig(), 268, CustomConfig.getSpartanWeaponryConfig(), Item.RAPIER).getNmsItem();
    private static ItemStack icedDragonBoneKatana = new Item(CustomConfig.getItemsConfig(), 269, CustomConfig.getSpartanWeaponryConfig(), Item.KATANA).getNmsItem();
    private static ItemStack icedDragonBoneGreatsword = new Item(CustomConfig.getItemsConfig(), 270, CustomConfig.getSpartanWeaponryConfig(), Item.GREATSWORD).getNmsItem();
    private static ItemStack icedDragonBoneLongsword = new Item(CustomConfig.getItemsConfig(), 271, CustomConfig.getSpartanWeaponryConfig(), Item.LONGSWORD).getNmsItem();
    private static ItemStack icedDragonBoneSpear = new Item(CustomConfig.getItemsConfig(), 272, CustomConfig.getSpartanWeaponryConfig(), Item.SPEAR).getNmsItem();
    private static ItemStack icedDragonBoneSaber = new Item(CustomConfig.getItemsConfig(), 273, CustomConfig.getSpartanWeaponryConfig(), Item.SABER).getNmsItem();
    private static ItemStack icedDragonBoneBoomerang = new Item(CustomConfig.getItemsConfig(), 274, CustomConfig.getSpartanWeaponryConfig(), Item.BOOMERANG).getNmsItem();
    private static ItemStack icedDragonBoneDagger = new Item(CustomConfig.getItemsConfig(), 275, CustomConfig.getSpartanWeaponryConfig(), Item.DAGGER).getNmsItem();
    private static ItemStack icedDragonBoneGlaive = new Item(CustomConfig.getItemsConfig(), 276, CustomConfig.getSpartanWeaponryConfig(), Item.GLAIVE).getNmsItem();
    private static ItemStack icedDragonBoneHalberd = new Item(CustomConfig.getItemsConfig(), 277, CustomConfig.getSpartanWeaponryConfig(), Item.HALBERD).getNmsItem();
    private static ItemStack icedDragonBoneHammer = new Item(CustomConfig.getItemsConfig(), 278, CustomConfig.getSpartanWeaponryConfig(), Item.HAMMER).getNmsItem();
    private static ItemStack icedDragonBoneJavelin = new Item(CustomConfig.getItemsConfig(), 279, CustomConfig.getSpartanWeaponryConfig(), Item.JAVELIN).getNmsItem();
    private static ItemStack icedDragonBoneLance = new Item(CustomConfig.getItemsConfig(), 280, CustomConfig.getSpartanWeaponryConfig(), Item.LANCE).getNmsItem();
    private static ItemStack icedDragonBoneMace = new Item(CustomConfig.getItemsConfig(), 281, CustomConfig.getSpartanWeaponryConfig(), Item.MACE).getNmsItem();
    private static ItemStack icedDragonBonePike = new Item(CustomConfig.getItemsConfig(), 282, CustomConfig.getSpartanWeaponryConfig(), Item.PIKE).getNmsItem();
    private static ItemStack icedDragonBoneQuarterstaff = new Item(CustomConfig.getItemsConfig(), 283, CustomConfig.getSpartanWeaponryConfig(), Item.QUARTERSTAFF).getNmsItem();
    private static ItemStack icedDragonBoneThrowingAxe = new Item(CustomConfig.getItemsConfig(), 284, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_AXE).getNmsItem();
    private static ItemStack icedDragonBoneThrowingKnife = new Item(CustomConfig.getItemsConfig(), 285, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_KNIFE).getNmsItem();
    private static ItemStack icedDragonBoneWarhammer = new Item(CustomConfig.getItemsConfig(), 286, CustomConfig.getSpartanWeaponryConfig(), Item.WARHAMMER).getNmsItem();
    private static ItemStack icedDragonBoneBattleaxe = new Item(CustomConfig.getItemsConfig(), 287, CustomConfig.getSpartanWeaponryConfig(), Item.BATTLEAXE).getNmsItem();
    ...
    private static ItemStack lightningDragonBoneRapier = new Item(CustomConfig.getItemsConfig(), 290, CustomConfig.getSpartanWeaponryConfig(), Item.RAPIER).getNmsItem();
    private static ItemStack lightningDragonBoneKatana = new Item(CustomConfig.getItemsConfig(), 291, CustomConfig.getSpartanWeaponryConfig(), Item.KATANA).getNmsItem();
    private static ItemStack lightningDragonBoneGreatsword = new Item(CustomConfig.getItemsConfig(), 292, CustomConfig.getSpartanWeaponryConfig(), Item.GREATSWORD).getNmsItem();
    private static ItemStack lightningDragonBoneLongsword = new Item(CustomConfig.getItemsConfig(), 293, CustomConfig.getSpartanWeaponryConfig(), Item.LONGSWORD).getNmsItem();
    private static ItemStack lightningDragonBoneSpear = new Item(CustomConfig.getItemsConfig(), 294, CustomConfig.getSpartanWeaponryConfig(), Item.SPEAR).getNmsItem();
    private static ItemStack lightningDragonBoneSaber = new Item(CustomConfig.getItemsConfig(), 295, CustomConfig.getSpartanWeaponryConfig(), Item.SABER).getNmsItem();
    private static ItemStack lightningDragonBoneBoomerang = new Item(CustomConfig.getItemsConfig(), 296, CustomConfig.getSpartanWeaponryConfig(), Item.BOOMERANG).getNmsItem();
    private static ItemStack lightningDragonBoneDagger = new Item(CustomConfig.getItemsConfig(), 297, CustomConfig.getSpartanWeaponryConfig(), Item.DAGGER).getNmsItem();
    private static ItemStack lightningDragonBoneGlaive = new Item(CustomConfig.getItemsConfig(), 298, CustomConfig.getSpartanWeaponryConfig(), Item.GLAIVE).getNmsItem();
    private static ItemStack lightningDragonBoneHalberd = new Item(CustomConfig.getItemsConfig(), 299, CustomConfig.getSpartanWeaponryConfig(), Item.HALBERD).getNmsItem();
    private static ItemStack lightningDragonBoneHammer = new Item(CustomConfig.getItemsConfig(), 300, CustomConfig.getSpartanWeaponryConfig(), Item.HAMMER).getNmsItem();
    private static ItemStack lightningDragonBoneJavelin = new Item(CustomConfig.getItemsConfig(), 301, CustomConfig.getSpartanWeaponryConfig(), Item.JAVELIN).getNmsItem();
    private static ItemStack lightningDragonBoneLance = new Item(CustomConfig.getItemsConfig(), 302, CustomConfig.getSpartanWeaponryConfig(), Item.LANCE).getNmsItem();
    private static ItemStack lightningDragonBoneMace = new Item(CustomConfig.getItemsConfig(), 303, CustomConfig.getSpartanWeaponryConfig(), Item.MACE).getNmsItem();
    private static ItemStack lightningDragonBonePike = new Item(CustomConfig.getItemsConfig(), 304, CustomConfig.getSpartanWeaponryConfig(), Item.PIKE).getNmsItem();
    private static ItemStack lightningDragonBoneQuarterstaff = new Item(CustomConfig.getItemsConfig(), 305, CustomConfig.getSpartanWeaponryConfig(), Item.QUARTERSTAFF).getNmsItem();
    private static ItemStack lightningDragonBoneThrowingAxe = new Item(CustomConfig.getItemsConfig(), 306, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_AXE).getNmsItem();
    private static ItemStack lightningDragonBoneThrowingKnife = new Item(CustomConfig.getItemsConfig(), 307, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_KNIFE).getNmsItem();
    private static ItemStack lightningDragonBoneWarhammer = new Item(CustomConfig.getItemsConfig(), 308, CustomConfig.getSpartanWeaponryConfig(), Item.WARHAMMER).getNmsItem();
    private static ItemStack lightningDragonBoneBattleaxe = new Item(CustomConfig.getItemsConfig(), 309, CustomConfig.getSpartanWeaponryConfig(), Item.BATTLEAXE).getNmsItem();
    ...
    private static ItemStack fireDragonsteelRapier = new Item(CustomConfig.getItemsConfig(), 312, CustomConfig.getSpartanWeaponryConfig(), Item.RAPIER).getNmsItem();
    private static ItemStack fireDragonsteelKatana = new Item(CustomConfig.getItemsConfig(), 313, CustomConfig.getSpartanWeaponryConfig(), Item.KATANA).getNmsItem();
    private static ItemStack fireDragonsteelGreatsword = new Item(CustomConfig.getItemsConfig(), 314, CustomConfig.getSpartanWeaponryConfig(), Item.GREATSWORD).getNmsItem();
    private static ItemStack fireDragonsteelLongsword = new Item(CustomConfig.getItemsConfig(), 315, CustomConfig.getSpartanWeaponryConfig(), Item.LONGSWORD).getNmsItem();
    private static ItemStack fireDragonsteelSpear = new Item(CustomConfig.getItemsConfig(), 316, CustomConfig.getSpartanWeaponryConfig(), Item.SPEAR).getNmsItem();
    private static ItemStack fireDragonsteelSaber = new Item(CustomConfig.getItemsConfig(), 317, CustomConfig.getSpartanWeaponryConfig(), Item.SABER).getNmsItem();
    private static ItemStack fireDragonsteelBoomerang = new Item(CustomConfig.getItemsConfig(), 318, CustomConfig.getSpartanWeaponryConfig(), Item.BOOMERANG).getNmsItem();
    private static ItemStack fireDragonsteelDagger = new Item(CustomConfig.getItemsConfig(), 319, CustomConfig.getSpartanWeaponryConfig(), Item.DAGGER).getNmsItem();
    private static ItemStack fireDragonsteelGlaive = new Item(CustomConfig.getItemsConfig(), 320, CustomConfig.getSpartanWeaponryConfig(), Item.GLAIVE).getNmsItem();
    private static ItemStack fireDragonsteelHalberd = new Item(CustomConfig.getItemsConfig(), 321, CustomConfig.getSpartanWeaponryConfig(), Item.HALBERD).getNmsItem();
    private static ItemStack fireDragonsteelHammer = new Item(CustomConfig.getItemsConfig(), 322, CustomConfig.getSpartanWeaponryConfig(), Item.HAMMER).getNmsItem();
    private static ItemStack fireDragonsteelJavelin = new Item(CustomConfig.getItemsConfig(), 323, CustomConfig.getSpartanWeaponryConfig(), Item.JAVELIN).getNmsItem();
    private static ItemStack fireDragonsteelLance = new Item(CustomConfig.getItemsConfig(), 324, CustomConfig.getSpartanWeaponryConfig(), Item.LANCE).getNmsItem();
    private static ItemStack fireDragonsteelMace = new Item(CustomConfig.getItemsConfig(), 325, CustomConfig.getSpartanWeaponryConfig(), Item.MACE).getNmsItem();
    private static ItemStack fireDragonsteelPike = new Item(CustomConfig.getItemsConfig(), 326, CustomConfig.getSpartanWeaponryConfig(), Item.PIKE).getNmsItem();
    private static ItemStack fireDragonsteelQuarterstaff = new Item(CustomConfig.getItemsConfig(), 327, CustomConfig.getSpartanWeaponryConfig(), Item.QUARTERSTAFF).getNmsItem();
    private static ItemStack fireDragonsteelThrowingAxe = new Item(CustomConfig.getItemsConfig(), 328, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_AXE).getNmsItem();
    private static ItemStack fireDragonsteelThrowingKnife = new Item(CustomConfig.getItemsConfig(), 329, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_KNIFE).getNmsItem();
    private static ItemStack fireDragonsteelWarhammer = new Item(CustomConfig.getItemsConfig(), 330, CustomConfig.getSpartanWeaponryConfig(), Item.WARHAMMER).getNmsItem();
    private static ItemStack fireDragonsteelBattleaxe = new Item(CustomConfig.getItemsConfig(), 331, CustomConfig.getSpartanWeaponryConfig(), Item.BATTLEAXE).getNmsItem();
    ...
    private static ItemStack iceDragonsteelRapier = new Item(CustomConfig.getItemsConfig(), 334, CustomConfig.getSpartanWeaponryConfig(), Item.RAPIER).getNmsItem();
    private static ItemStack iceDragonsteelKatana = new Item(CustomConfig.getItemsConfig(), 335, CustomConfig.getSpartanWeaponryConfig(), Item.KATANA).getNmsItem();
    private static ItemStack iceDragonsteelGreatsword = new Item(CustomConfig.getItemsConfig(), 336, CustomConfig.getSpartanWeaponryConfig(), Item.GREATSWORD).getNmsItem();
    private static ItemStack iceDragonsteelLongsword = new Item(CustomConfig.getItemsConfig(), 337, CustomConfig.getSpartanWeaponryConfig(), Item.LONGSWORD).getNmsItem();
    private static ItemStack iceDragonsteelSpear = new Item(CustomConfig.getItemsConfig(), 338, CustomConfig.getSpartanWeaponryConfig(), Item.SPEAR).getNmsItem();
    private static ItemStack iceDragonsteelSaber = new Item(CustomConfig.getItemsConfig(), 339, CustomConfig.getSpartanWeaponryConfig(), Item.SABER).getNmsItem();
    private static ItemStack iceDragonsteelBoomerang = new Item(CustomConfig.getItemsConfig(), 340, CustomConfig.getSpartanWeaponryConfig(), Item.BOOMERANG).getNmsItem();
    private static ItemStack iceDragonsteelDagger = new Item(CustomConfig.getItemsConfig(), 341, CustomConfig.getSpartanWeaponryConfig(), Item.DAGGER).getNmsItem();
    private static ItemStack iceDragonsteelGlaive = new Item(CustomConfig.getItemsConfig(), 342, CustomConfig.getSpartanWeaponryConfig(), Item.GLAIVE).getNmsItem();
    private static ItemStack iceDragonsteelHalberd = new Item(CustomConfig.getItemsConfig(), 343, CustomConfig.getSpartanWeaponryConfig(), Item.HALBERD).getNmsItem();
    private static ItemStack iceDragonsteelHammer = new Item(CustomConfig.getItemsConfig(), 344, CustomConfig.getSpartanWeaponryConfig(), Item.HAMMER).getNmsItem();
    private static ItemStack iceDragonsteelJavelin = new Item(CustomConfig.getItemsConfig(), 345, CustomConfig.getSpartanWeaponryConfig(), Item.JAVELIN).getNmsItem();
    private static ItemStack iceDragonsteelLance = new Item(CustomConfig.getItemsConfig(), 346, CustomConfig.getSpartanWeaponryConfig(), Item.LANCE).getNmsItem();
    private static ItemStack iceDragonsteelMace = new Item(CustomConfig.getItemsConfig(), 347, CustomConfig.getSpartanWeaponryConfig(), Item.MACE).getNmsItem();
    private static ItemStack iceDragonsteelPike = new Item(CustomConfig.getItemsConfig(), 348, CustomConfig.getSpartanWeaponryConfig(), Item.PIKE).getNmsItem();
    private static ItemStack iceDragonsteelQuarterstaff = new Item(CustomConfig.getItemsConfig(), 349, CustomConfig.getSpartanWeaponryConfig(), Item.QUARTERSTAFF).getNmsItem();
    private static ItemStack iceDragonsteelThrowingAxe = new Item(CustomConfig.getItemsConfig(), 350, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_AXE).getNmsItem();
    private static ItemStack iceDragonsteelThrowingKnife = new Item(CustomConfig.getItemsConfig(), 351, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_KNIFE).getNmsItem();
    private static ItemStack iceDragonsteelWarhammer = new Item(CustomConfig.getItemsConfig(), 352, CustomConfig.getSpartanWeaponryConfig(), Item.WARHAMMER).getNmsItem();
    private static ItemStack iceDragonsteelBattleaxe = new Item(CustomConfig.getItemsConfig(), 353, CustomConfig.getSpartanWeaponryConfig(), Item.BATTLEAXE).getNmsItem();
    ...
    private static ItemStack lightningDragonsteelRapier = new Item(CustomConfig.getItemsConfig(), 356, CustomConfig.getSpartanWeaponryConfig(), Item.RAPIER).getNmsItem();
    private static ItemStack lightningDragonsteelKatana = new Item(CustomConfig.getItemsConfig(), 357, CustomConfig.getSpartanWeaponryConfig(), Item.KATANA).getNmsItem();
    private static ItemStack lightningDragonsteelGreatsword = new Item(CustomConfig.getItemsConfig(), 358, CustomConfig.getSpartanWeaponryConfig(), Item.GREATSWORD).getNmsItem();
    private static ItemStack lightningDragonsteelLongsword = new Item(CustomConfig.getItemsConfig(), 359, CustomConfig.getSpartanWeaponryConfig(), Item.LONGSWORD).getNmsItem();
    private static ItemStack lightningDragonsteelSpear = new Item(CustomConfig.getItemsConfig(), 360, CustomConfig.getSpartanWeaponryConfig(), Item.SPEAR).getNmsItem();
    private static ItemStack lightningDragonsteelSaber = new Item(CustomConfig.getItemsConfig(), 361, CustomConfig.getSpartanWeaponryConfig(), Item.SABER).getNmsItem();
    private static ItemStack lightningDragonsteelBoomerang = new Item(CustomConfig.getItemsConfig(), 362, CustomConfig.getSpartanWeaponryConfig(), Item.BOOMERANG).getNmsItem();
    private static ItemStack lightningDragonsteelDagger = new Item(CustomConfig.getItemsConfig(), 363, CustomConfig.getSpartanWeaponryConfig(), Item.DAGGER).getNmsItem();
    private static ItemStack lightningDragonsteelGlaive = new Item(CustomConfig.getItemsConfig(), 364, CustomConfig.getSpartanWeaponryConfig(), Item.GLAIVE).getNmsItem();
    private static ItemStack lightningDragonsteelHalberd = new Item(CustomConfig.getItemsConfig(), 365, CustomConfig.getSpartanWeaponryConfig(), Item.HALBERD).getNmsItem();
    private static ItemStack lightningDragonsteelHammer = new Item(CustomConfig.getItemsConfig(), 366, CustomConfig.getSpartanWeaponryConfig(), Item.HAMMER).getNmsItem();
    private static ItemStack lightningDragonsteelJavelin = new Item(CustomConfig.getItemsConfig(), 367, CustomConfig.getSpartanWeaponryConfig(), Item.JAVELIN).getNmsItem();
    private static ItemStack lightningDragonsteelLance = new Item(CustomConfig.getItemsConfig(), 368, CustomConfig.getSpartanWeaponryConfig(), Item.LANCE).getNmsItem();
    private static ItemStack lightningDragonsteelMace = new Item(CustomConfig.getItemsConfig(), 369, CustomConfig.getSpartanWeaponryConfig(), Item.MACE).getNmsItem();
    private static ItemStack lightningDragonsteelPike = new Item(CustomConfig.getItemsConfig(), 370, CustomConfig.getSpartanWeaponryConfig(), Item.PIKE).getNmsItem();
    private static ItemStack lightningDragonsteelQuarterstaff = new Item(CustomConfig.getItemsConfig(), 371, CustomConfig.getSpartanWeaponryConfig(), Item.QUARTERSTAFF).getNmsItem();
    private static ItemStack lightningDragonsteelThrowingAxe = new Item(CustomConfig.getItemsConfig(), 372, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_AXE).getNmsItem();
    private static ItemStack lightningDragonsteelThrowingKnife = new Item(CustomConfig.getItemsConfig(), 373, CustomConfig.getSpartanWeaponryConfig(), Item.THROWING_KNIFE).getNmsItem();
    private static ItemStack lightningDragonsteelWarhammer = new Item(CustomConfig.getItemsConfig(), 374, CustomConfig.getSpartanWeaponryConfig(), Item.WARHAMMER).getNmsItem();
    private static ItemStack lightningDragonsteelBattleaxe = new Item(CustomConfig.getItemsConfig(), 375, CustomConfig.getSpartanWeaponryConfig(), Item.BATTLEAXE).getNmsItem();
