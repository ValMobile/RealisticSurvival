...
public abstract class Dragon_v1_19_R5 extends EnderDragon implements Dragon {
    ...
    public Dragon_v1_19_R5(EntityType<? extends EnderDragon> entityType, Level world, DragonBreed breed) {
    ...
    public Dragon_v1_19_R5(Location loc, DragonBreed breed) {
    ...
    public Dragon_v1_19_R5(Location loc, DragonBreed breed, DragonVariant variant) {
        super(EntityType.ENDER_DRAGON, ((CraftWorld) loc.getWorld()).getHandle());
        this.setPos(loc.getX(), loc.getY(), loc.getZ());
    ...
    public Dragon_v1_19_R5(Location loc, DragonBreed breed, int stage) {
        super(EntityType.ENDER_DRAGON, ((CraftWorld) loc.getWorld()).getHandle());
        this.setPos(loc.getX(), loc.getY(), loc.getZ());
    ...
    public Dragon_v1_19_R5(Location loc, DragonBreed breed, DragonVariant variant, int stage) {
        super(EntityType.ENDER_DRAGON, ((CraftWorld) loc.getWorld()).getHandle());
        this.setPos(loc.getX(), loc.getY(), loc.getZ());
