...
public class Siren_v1_19_R4 extends Guardian implements Siren {

    public Siren_v1_19_R4(EntityType<? extends Guardian> entitytype, Level world) {
        super(entitytype, world);

        setup();
    }

    public Siren_v1_19_R4(Location loc) {
