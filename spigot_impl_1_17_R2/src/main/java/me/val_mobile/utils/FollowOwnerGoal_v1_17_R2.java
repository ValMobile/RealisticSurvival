...
public class FollowOwnerGoal_v1_17_R2 extends Goal {
    ...
    public FollowOwnerGoal_v1_17_R2(RSVPet pet, double d0, float f, float f1, boolean flag) {
        this.pet = pet;
    ...
    private boolean canTeleportTo(BlockPos blockposition) {
        ...
        if (pathtype != BlockPathTypes.WALKABLE) {
            ...
            BlockState iblockdata = level.getBlockState(blockposition.down());
            if (!canFly && iblockdata.getBlock() instanceof LeavesBlock) {
                return false;
            } else {
                BlockPos blockposition1 = blockposition.e(mob.blockPosition());
