...
public class Siren_v1_17_R2 extends Guardian implements Siren {

    public Siren_v1_17_R2(EntityType<? extends Guardian> entitytype, Level world) {
        super(entitytype, world);

        setup();
    }

    public Siren_v1_17_R2(Location loc) {
