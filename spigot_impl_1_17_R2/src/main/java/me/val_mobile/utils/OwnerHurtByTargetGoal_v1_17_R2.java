...
public class OwnerHurtByTargetGoal_v1_17_R2 extends TargetGoal {
    private final RSVPet pet;
    private LivingEntity ownerLastHurtBy;
    private int timestamp;

    public OwnerHurtByTargetGoal_v1_17_R2(RSVPet pet) {
    ...
    public void start() {
        mob.setGoalTarget(ownerLastHurtBy, EntityTargetEvent.TargetReason.TARGET_ATTACKED_OWNER, true);
