...
public class EndermanTakeBlockGoal_v1_17_R2 extends Goal {
    private final EnderMan enderman;

    public EndermanTakeBlockGoal_v1_17_R2(EnderMan enderman) {
        this.enderman = enderman;
    }

    public boolean canUse() {
        return this.enderman.getCarriedBlock() == null && (enderman.level.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) && enderman.getRandom().nextInt(20) == 0);
    }
