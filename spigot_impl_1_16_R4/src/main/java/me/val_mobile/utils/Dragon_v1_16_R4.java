...
public abstract class Dragon_v1_16_R4 extends EntityEnderDragon implements Dragon {
    ...
    public Dragon_v1_16_R4(EntityTypes<? extends EntityEnderDragon> entityTypes, net.minecraft.server.v1_16_R3.World world, DragonBreed breed) {
    ...
    public Dragon_v1_16_R4(Location loc, DragonBreed breed) {
    ...
    public Dragon_v1_16_R4(Location loc, DragonBreed breed, DragonVariant variant) {
        super(EntityTypes.ENDER_DRAGON, ((CraftWorld) loc.getWorld()).getHandle());
        this.setPosition(loc.getX(), loc.getY(), loc.getZ());
    ...
    public Dragon_v1_16_R4(Location loc, DragonBreed breed, int stage) {
        super(EntityTypes.ENDER_DRAGON, ((CraftWorld) loc.getWorld()).getHandle());
        this.setPosition(loc.getX(), loc.getY(), loc.getZ());
    ...
    public Dragon_v1_16_R4(Location loc, DragonBreed breed, DragonVariant variant, int stage) {
        super(EntityTypes.ENDER_DRAGON, ((CraftWorld) loc.getWorld()).getHandle());
        this.setPosition(loc.getX(), loc.getY(), loc.getZ());
