...
public class Siren_v1_16_R4 extends EntityGuardian implements Siren {

    private final FileConfiguration config;

    public Siren_v1_16_R4(EntityTypes<? extends EntityGuardian> entitytypes, World world) {
    ...
    public Siren_v1_16_R4(Location loc) {
