...
public class SeaSerpent_v1_16_R4 extends EntityGuardianElder implements SeaSerpent {
    ...
    public SeaSerpent_v1_16_R4(EntityTypes<? extends EntityGuardianElder> entitytypes, net.minecraft.server.v1_16_R3.World world) {
    ...
    public SeaSerpent_v1_16_R4(Location loc) {
    ...
    public SeaSerpent_v1_16_R4(Location loc, SeaSerpentVariant variant) {
        super(EntityTypes.ELDER_GUARDIAN, ((CraftWorld) loc.getWorld()).getHandle());
        this.setPosition(loc.getX(), loc.getY(), loc.getZ());
