...
public class Siren_v1_18_R1 extends Guardian implements Siren {

    private final FileConfiguration config;

    public Siren_v1_18_R1(EntityType<? extends Guardian> entitytype, Level world) {
    ...
    public Siren_v1_18_R1(Location loc) {
