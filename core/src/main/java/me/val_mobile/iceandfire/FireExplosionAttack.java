...
public class FireExplosionAttack extends ExplosionAttack {
    ...
    public FireExplosionAttack(EnderDragon dragon, Location target, RealisticSurvivalPlugin plugin) {
        super(dragon, target, plugin);
    }

    public FireExplosionAttack(Dragon dragon, Location target, RealisticSurvivalPlugin plugin) {
        super(dragon, target, plugin);
    }
