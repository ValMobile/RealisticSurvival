...
public class RSVStonecuttingRecipe extends StonecuttingRecipe implements RSVRecipe {

    public RSVStonecuttingRecipe(FileConfiguration config, String name, RSVPlugin plugin) {
