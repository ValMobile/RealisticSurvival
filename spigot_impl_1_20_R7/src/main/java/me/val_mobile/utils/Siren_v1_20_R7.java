...
public class Siren_v1_20_R7 extends Guardian implements Siren {

    public Siren_v1_20_R7(EntityType<? extends Guardian> entitytype, Level world) {
        super(entitytype, world);

        setup();
    }

    public Siren_v1_20_R7(Location loc) {
