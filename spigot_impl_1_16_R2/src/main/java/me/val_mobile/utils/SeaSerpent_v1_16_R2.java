...
public class SeaSerpent_v1_16_R2 extends EntityGuardianElder implements SeaSerpent {

    private final SeaSerpentVariant variant;
    private final Collection<ItemStack> loot = new ArrayList<>();

    public SeaSerpent_v1_16_R2(EntityTypes<? extends EntityGuardianElder> entitytypes, net.minecraft.server.v1_16_R2.World world) {
        ...
        this.setCustomName(new ChatComponentText(Utils.translateMsg("Realistic Survival " + StringUtils.capitalize(variant.toString().toLowerCase()) + " Sea Serpent")));
        this.setCustomNameVisible(false);
        addNbtData();
    }

    public SeaSerpent_v1_16_R2(Location loc) {
    ...
    public SeaSerpent_v1_16_R2(Location loc, SeaSerpentVariant variant) {
        super(EntityTypes.ELDER_GUARDIAN, ((CraftWorld) loc.getWorld()).getHandle());
        this.setPosition(loc.getX(), loc.getY(), loc.getZ());
