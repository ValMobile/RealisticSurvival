...
public class v1_16_R2 extends InternalsProvider {
    ...
    public void registerEntities() {
        CustomEntities_v1_16_R2.registerEntities();
    }
    ...
    public static boolean isLookingAtMe(EntityEnderman enderman, EntityHuman entityhuman) {
        net.minecraft.server.v1_16_R2.ItemStack itemstack = entityhuman.inventory.armor.get(3);
    ...
    public static boolean teleportTowards(EntityEnderman enderman, net.minecraft.server.v1_16_R2.Entity entity) {
