...
public class Siren_v1_16_R2 extends EntityGuardian implements Siren {

    private final FileConfiguration config;

    public Siren_v1_16_R2(EntityTypes<? extends EntityGuardian> entitytypes, World world) {
    ...
    public Siren_v1_16_R2(Location loc) {
    ...
    public void die(DamageSource damageSource) {
        ...
        ItemStack item = null;
        net.minecraft.server.v1_16_R2.Entity nmsEntity = damageSource.getEntity();
        if (nmsEntity != null) {
