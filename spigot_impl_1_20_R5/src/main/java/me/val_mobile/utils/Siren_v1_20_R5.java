...
public class Siren_v1_20_R5 extends Guardian implements Siren {

    public Siren_v1_20_R5(EntityType<? extends Guardian> entitytype, Level world) {
        super(entitytype, world);

        setup();
    }

    public Siren_v1_20_R5(Location loc) {
